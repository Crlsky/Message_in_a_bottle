 ...
 */
define('SWEETCAPTCHA_APP_ID', 244895); // your application id (change me)
define('SWEETCAPTCHA_KEY', '4c2afc5e1dbb2a87c51476b78984a4e2'); // your application key (change me)
define('SWEETCAPTCHA_SECRET', 'c48162a5cab03d74d2e31029ff1c8b21'); // your application secret (change me)
define('SWEETCAPTCHA_PUBLIC_URL', 'php/sweetcaptcha.php'); // public http url to this file
